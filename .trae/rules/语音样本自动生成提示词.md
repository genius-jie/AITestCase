...
## 输出结果
1. **CSV文件**：`e:\AI测试用例\python\vad_test\vad_test_data_comprehensive.csv`
...
- **执行命令**：在`e:\AI测试用例\python\vad_test`目录下运行 `python generate_vad_samples.py --test-data vad_test_data_comprehensive.csv`
